...
// exposed to the browser. Mirrors backend/database.js and
// coordinator-service/database.js so the data service writes to the exact same
// tables the cron job did.
